...
import styles from "../CourseContentMobile/CourseContentMob.module.css";
import style1 from "./CourseExpand.module.css";
...
const CourseContentMob = ({ allmoduledata, syllabus }) => {
  ...
  return (
    <div className=" section-width">
      <div className={style1.courseExpandMainHeadContainer}>
        <div className={style1.courseExpandMainHeadHeading}>
        ...
        {syllabus !== null ? (
          <div className={style1.syllabusContainer} onClick={downloadbtn}>
            <h1>
        ...
        {allmoduledata.length !== 0
          ? allmoduledata.map((data, index) => (
              <div className={styles.coruseContent} key={index}>
                <div className={styles.coruseContentHead1}>
                  <h1>{data.title}</h1>
                  {indexvalue == index ? (
                    isExpand === true ? (
                      <IoIosArrowUp
